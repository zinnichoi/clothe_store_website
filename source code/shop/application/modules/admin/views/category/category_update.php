            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div style="margin-top: 7em;" class="modal-header">
                        <h3 style="text-align: center; font-weight: 700;" class="modal-title" id="exampleModalLabel">Update category</h3>
                    ...
                    <div class="modal-body">
                        <form action="" method="post" enctype="multipart/form-data">
                            <h5> Type</h5>
                            <td><input type="text" name="cat_title" value="<?php echo $category[0]['cat_title']?>" required="name"></td>
